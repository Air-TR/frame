package com.tr.frame.mqtt.config.callback;

import com.tr.frame.mqtt.config.properties.MqttProperties;
...
public class MqttCallBack implements MqttCallbackExtended {
    ...
    public void connectionLost(Throwable throwable) {
        System.out.println(mqttProperties.getClientId() + " 与服务器断开连接，可重连，" + new Date());
    }
