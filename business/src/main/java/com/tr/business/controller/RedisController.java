...
import com.tr.frame.common.kit.CollectionKit;
import com.tr.frame.jedis.service.RedisPoolService;
...
public class RedisController {
    ...
    public List<String> get(@PathVariable Integer database) {
        ...
        return CollectionKit.isEmpty(keys) ? null : redisPoolService.mget(database, keys.toArray(new String[keys.size()]));
    }
    ...
    public List<String> get() {
        ...
        return CollectionKit.isEmpty(keys) ? null : stringRedisTemplate.opsForValue().multiGet(keys);
    }
